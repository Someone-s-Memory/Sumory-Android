    ...
    override fun apply(target: Project) {
        with(target) {
            ...
            dependencies {
                ...
                add("implementation", project(":data:auth"))
                add("implementation", project(":data:diary"))
                add("implementation", project(":domain:auth"))
                add("implementation", project(":domain:diary"))
